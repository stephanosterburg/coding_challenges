...
def findProfession(level, pos):
    ...
    Example:
        pos 2 => 0b10 - 1  => 0b1  => counts one number 1 == Doctor
        pos 3 => 0b11 - 1  => 0b10 => counts one number 1 == Doctor
        pos 3 => 0b100 - 1 => 0b11 => counts one number 1 == Engineer
    """
    bits = bin(pos - 1).count('1')  

    print('pos: {} -> {} -> {}'.format(pos, bin(pos-1), bits))
