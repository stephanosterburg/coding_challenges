...
#
# Then create another function to get the function number (as an integer)
# and return the Function.
#
# So, if you want function of X+2, you call the method by MethodFunc(2)
#
...
# Write your function so that any call such as
# MethodFunc(x)(y) outputs x+y. (1<=x<=4)
